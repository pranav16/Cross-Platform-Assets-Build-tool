	...
	// Initialize the API object
	{
		...
		sDdsInfo ddsInfo;
		{
			...
			else
			{
				...
				Logging::OutputError( "The width (%u) of the DDS file %s is too big", header->dwWidth, i_path );
				goto OnExit;
			}
			...
			else
			{
				...
				Logging::OutputError( "The width (%u) of the DDS file %s is too big", header->dwHeight, i_path );
				goto OnExit;
			}
