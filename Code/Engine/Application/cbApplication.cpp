...
#include "../Graphics/GraphicsDataTypes.h"
...
// Run
//----
void eae6320::Application::cbApplication::updateActorsList(std::vector<eae6320::Graphics::RenderData*>renderdata, std::vector<eae6320::Graphics::SpriteRenderData*>sprites)
{
	listOfRenderables = renderdata;
...
void eae6320::Application::cbApplication::OnNewFrame()
{
	Time::OnNewFrame();
	Update();
	Graphics::SubmitDrawData(listOfRenderables,listOfSprites);
	Graphics::BeginRenderFrame();
	Graphics::RenderFrame();
	Graphics::EndRenderFrame();
	listOfRenderables.clear();
}
