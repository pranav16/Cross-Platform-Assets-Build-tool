...
namespace eae6320
{
	...
	namespace Application
	{
		...
		public:
			...
			void updateActorsList(std::vector<eae6320::Graphics::RenderData*>renderdata, std::vector<eae6320::Graphics::SpriteRenderData*>sprites);
			// Inheritable Implementation
			//===========================
	
			
		private:
			std::vector<eae6320::Graphics::RenderData*>listOfRenderables;
			std::vector<eae6320::Graphics::SpriteRenderData*>listOfSprites;
