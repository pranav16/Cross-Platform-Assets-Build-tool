			...
			if ( lua_isnumber( &io_luaState, -1 ) )
			{
				...
				if ( IsNumberAnInteger( floatingPointResult ) )
				{
					if ( floatingPointResult >= lua_Number( 0 ) )
					{
						...
						eae6320::Logging::OutputMessage("width read from settings.ini %u", s_resolutionWidth);
					}
					else
					{
			...
			if ( lua_isnumber( &io_luaState, -1 ) )
			{
				...
				if ( IsNumberAnInteger( floatingPointResult ) )
				{
					if ( floatingPointResult >= lua_Number( 0 ) )
					{
						...
						eae6320::Logging::OutputMessage("h read from settings.ini %u", s_resolutionHeight);
					}
					else
					{
